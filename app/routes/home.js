...
export default class HomeRoute extends Route {
    model(){
        return {
            slides:[
                {
                    imgSrc: '01-residential-1920x1080-tseng.jpg',
                ...
                {
                    imgSrc: '02-municipalities-1920x1080-deputy-ken-collier-park.jpg',
                    category: 'municipalities',
                    title: 'Deputy Ken Collier Park',
                    location: 'Santee, CA'
                },
                {
                    imgSrc: '03-municipalities-1920x1080-frontier-park.jpg',
                    category: 'municipalities',
                    title: 'Frontier Park',
                    location: 'Cerritos, CA'
                },
                {
                    imgSrc: '04-commercial-1920x1080-heidman-es.jpg',
                    category: 'commercial',
            ...
            projects: [
                ...
                {
                    imgSrc: '03-residential-426x574-tseng.jpg',
                    category:'residential',
                    title: 'Tseng Residence',
                    description: 'Lorem ipsum dolor sit amet, consectetur adipil pcing elit. Proin nunc leo, rhoncus sit amet tolil arcu vel, pharetra volutpat sem lorn Donec tincidunt velit nec laoreet semper...'
                },
                {
                    imgSrc: '04-residential-426x574-mccadden.jpg',
                    category:'residential',
